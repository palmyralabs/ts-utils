...
export type { OConsumer, IConsumer, BiConsumer, TriConsumer, IFunction, BiFunction, TriFunction }
export type { OPredicate, IPredicate, BiPredicate, TriPredicate, Supplier };